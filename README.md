...
12. **Polaroid wall** – drag the photos around.
13. **Fireworks** – each tap launches a burst that spells the next letter of her name.
14. **The ending** – the question, the runaway "No", photo rain, and a video message after Yes.
15. **Wish jar** – she writes a wish, it drops into the jar and is kept on her phone for next year.
...
3. Every media section (stories, mosaic, gallery, game, corkboard, photo rain) updates by itself.
   Sections that show a specific photo (intro face, timeline, "Through my eyes", then-and-now)
...
1. **Edit `src/content.js`.** Every word on the site lives there: her name, dates,
   the lock answer, the letter, timeline, reasons, balloon notes, the ending.
